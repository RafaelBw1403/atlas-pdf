...
export const setupHandlebarsHelpers = () => {
  try {
    // 1. Helpers de just-handlebars-helpers (pueden ser sobrescritos por custom)
    H.registerHelpers(Handlebars);

    // 2. Aliases para nombres comunes
...
const registerArrayHelpers = () => {
  ...
  Handlebars.registerHelper('currency', (currencyCode: string, amount: number) => {
